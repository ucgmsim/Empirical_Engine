...
def ASK_2014_nga(
    mag, T, rrup, rjb, rx, ry0, delta, lamda, ztor=None, f_as=0, f_hw=0, w=None, z10=None, vs30: float=500.0, f_vs30: bool=True, region: int=0
):
    """
...
def ASK_2014_sub_1(
    ...
    if T[ip] <= 0.5:
        ...
        V1 = math.exp(-0.35 * math.log(T[ip] / 0.5) + math.log(1500))
    else:
        V1 = 800
