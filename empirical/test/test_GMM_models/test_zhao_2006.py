...
IM = "pSA"
TECT_TYPES = {
    "TectType.SUBDUCTION_SLAB": TectType.SUBDUCTION_SLAB,
    "TectType.SUBDUCTION_INTERFACE": TectType.SUBDUCTION_INTERFACE,
    "TectType.ACTIVE_SHALLOW": TectType.ACTIVE_SHALLOW,
}
SITE_CLASSES = {
    "SiteClass.SOFTSOIL": SiteClass.SOFTSOIL,
    "SiteClass.MEDIUMSOIL": SiteClass.MEDIUMSOIL,
    "SiteClass.HARDSOIL": SiteClass.HARDSOIL,
    "SiteClass.ROCK": SiteClass.ROCK,
    "SiteClass.HARDROCK": SiteClass.HARDROCK,
}
...
def test_zhao_2006(set_up):
    ...
    for index, row in df.iterrows():
        ...
        if not row.isnull().any():
            ...
            results = [compute_gmm(FAULT, SITE, GMM.ZA_06, IM, [row["period"]])]  # expects results in a list
