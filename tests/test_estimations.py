...
@pytest.mark.parametrize(
    ...
    [
        (30, 5.0, 3.16),  # Corrected value from the formula
        (45, 6.0, 8.91),  # Corrected value from the formula
        (60, 7.0, 20.78),
        (75, 8.0, 18.63),
        (90, 9.0, 18.0),
    ],
...
def test_estimate_width_ASK14_series() -> None:
    """Test the estimate_width_ASK14 function correctly handles Series inputs."""
    ...
    return widths  # Return the result for the wrapper to validate
